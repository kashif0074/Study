...
export default function NotesScreen({ navigation }) {
  ...
  const [notes, setNotes] = useState([
    ...
    { 
      ...
      content: "Complete physics formulas including Newton's laws, thermodynamics, and quantum mechanics principles.", 
      type: "Files", 
      date: "Yesterday",
      subject: "Physics",
      duration: "2h 15m",
    ...
    { 
      ...
      content: "Organic synthesis audio recording covering reaction mechanisms and lab procedures.", 
      type: "voice", 
      date: "3 days ago",
      subject: "Chemistry",
      duration: "45m",
  ...
  const renderNote = ({ item }) => (
    ...
    >
      <View style={styles.noteHeader}>
        ...
        >
          <Ionicons name="ellipsis-vertical" size={isSmallScreen ? 18 : isTablet ? 24 : 22} color="#9CA3AF" />
        </TouchableOpacity>
      </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <LinearGradient colors={["#6B21A8", "#6B21A8", "#4C1D95"]} style={styles.header}>
        <Text style={[
          styles.headerTitle,
        ...
        <View style={[
          ...
          <Ionicons name="search" size={isSmallScreen ? 18 : isTablet ? 24 : 22} color="#E9D5FF" />
          <TextInput
            style={[
              styles.searchInput,
              { 
          ...
          {filters.map(f => (
            ...
            >
              <Ionicons 
                ...
                color={filterType === f.value ? "#6B21A8" : "#E9D5FF"} 
              />
              <Text style={[
                styles.filterLabel,
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Ionicons name="document-outline" size={isSmallScreen ? 48 : isTablet ? 72 : 64} color="#C4B5FD" />
            <Text style={[
              styles.emptyText,
        ...
        >
          ...
          >
                ...
                {["text", "Files", "image", "voice"].map(t => (
                  ...
                  >
                    <Ionicons
                      ...
                      color={newNoteType === t ? "#fff" : getTypeColor(t)}
                    />
                    <Text style={[
                      styles.typeLabel,
                      newNoteType === t && { color: "#fff" },
                      { 
                        fontSize: isSmallScreen ? 12 : isTablet ? 16 : 14,
            ...
            {newNoteType === "text" ? (
              ...
              >
                <Ionicons name="document-attach" size={isSmallScreen ? 22 : isTablet ? 28 : 26} color="#6B21A8" />
              ...
              <TouchableOpacity 
                ...
                onPress={pickImage}
              >
                <Ionicons name="image" size={isSmallScreen ? 22 : isTablet ? 28 : 26} color="#6B21A8" />
                <View style={{ flex: 1, marginLeft: isSmallScreen ? 10 : isTablet ? 16 : 12 }}>
                  <Text style={[
                    styles.uploadText,
                    { fontSize: isSmallScreen ? 14 : isTablet ? 17 : 16 }
                  ]}>
                    {selectedFile ? "Image Selected" : "Pick Image"}
                  </Text>
                  {selectedFile && (
                    <Text style={[
                      styles.fileSizeText,
              ...
              <View style={styles.voiceRecordingContainer}>
                ...
                {isRecording && (
                  <View style={styles.recordingTimer}>
                    <Ionicons name="radio-button-on" size={isSmallScreen ? 16 : isTablet ? 20 : 18} color="#EF4444" />
                    <Text style={[
                ...
                {selectedFile && !isRecording && (
                  <View style={styles.recordingPreview}>
                    ...
                    >
                      <Ionicons name="close-circle" size={isSmallScreen ? 20 : isTablet ? 24 : 22} color="#9CA3AF" />
                    </TouchableOpacity>
                  </View>
                )}
              </View>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Ionicons name="bulb-outline" size={isSmallScreen ? 20 : isTablet ? 24 : 22} color="#6B21A8" />
              <Text style={[
                styles.menuText,
                { 
                  fontSize: isSmallScreen ? 14 : isTablet ? 18 : 16,
            ...
            >
              <Ionicons name="school-outline" size={isSmallScreen ? 20 : isTablet ? 24 : 22} color="#6B21A8" />
              <Text style={[
                styles.menuText,
                { 
                  fontSize: isSmallScreen ? 14 : isTablet ? 18 : 16,
            ...
            >
              <Ionicons name="share-outline" size={isSmallScreen ? 20 : isTablet ? 24 : 22} color="#6B21A8" />
              <Text style={[
                styles.menuText,
                { 
                  fontSize: isSmallScreen ? 14 : isTablet ? 18 : 16,
            ...
            >
              <Ionicons name="trash-outline" size={isSmallScreen ? 20 : isTablet ? 24 : 22} color="#DC2626" />
              <Text style={[
                styles.menuText,
                { 
                  fontSize: isSmallScreen ? 14 : isTablet ? 18 : 16,
